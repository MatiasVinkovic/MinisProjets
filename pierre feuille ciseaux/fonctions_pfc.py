...
def regles_jeu(choix_user,choix_pc):
    ...
    #le joueur gagne
    if choix_user == 2 and choix_pc == 1 or choix_user == 1 and choix_pc == 3 or choix_user == 3 and choix_pc == 2:
    ...
    #le joeur perd
    if choix_user == 1 and choix_pc == 2 or choix_user == 2 and choix_pc == 3 or choix_user == 3 and choix_pc == 1:
